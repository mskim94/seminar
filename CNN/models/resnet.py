...
def _resnet(arch, block, layers, pretrained, progress, num_classes, **kwargs):
    ...
    if pretrained:
        ...
        pretrained_state_dict.pop('fc.weight')  # remove last layer (fc.weight)
        pretrained_state_dict.pop('fc.bias')  # remove last layer (fc.bias)
...
# +
# def resnet18(pretrained=False, progress=True, num_classes=120, **kwargs):
